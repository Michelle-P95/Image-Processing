...
// 		anzahl pixel histogram
// 		iterieren zaehlen bis man 1 prozent hat
//    	
//    	for (int i = 0; i < histogramm ; i++) {
//    		= histogramm[i];
//    		
//    		}
//    	}
...
//    	// 1 % of all pix
////    	for (int = 0; i < grayLevels; i++ ) {
////    		pixelsc = pixelsc + histogramm[i];
//    	if (double) pixelsc / pixelstotal >= 0.01) {
//    		leftend = i;
//    	}
////    	
//    	pixelsc = pixelstotal/
//    	for (int index = grayLevels - 1; index >= 0; index --) {
//    		pixelsc -= histogram [i];
//    		if ((double)
//    		rightend = index;
//    	}
